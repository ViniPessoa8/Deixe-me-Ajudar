...
public class Activity_user_relatorio_gerar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        resetTelas();
        findViewById(R.id.includeuserrelatoriogerar).setVisibility(View.VISIBLE);

        //Email passado como parâmetro da activity
        Intent intent = getIntent();
        emailUser = intent.getStringExtra("emailUser");

        ImageButton btnVoltar = findViewById(R.id.btVoltarRelatorioGerar);

        btnVoltar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                resetTelas();
                Intent intent = new Intent(Activity_user_relatorio_gerar.this, Activity_inicio_pagina_inicial.class);
