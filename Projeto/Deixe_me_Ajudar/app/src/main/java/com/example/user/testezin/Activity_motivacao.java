...
public class Activity_motivacao extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.motivacao);
        ...
        btAdicionar.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent intent = new Intent(Activity_motivacao.this,Activity_motivacao_adicionar.class);
        ...
        btVoltar.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                Intent intent= new Intent(Activity_motivacao.this,MainActivity.class);
                intent.putExtra("emailUser", emailUser);
                intent.putExtra("admin", admin);
                startActivity(intent);
                finish();
