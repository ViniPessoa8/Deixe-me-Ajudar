...
public class Activity_exercicio_adicionar extends AppCompatActivity
{
    ImageView imagem;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.exercicio_adicionar);
        ...
        Button btSelecionarAnexo = (Button)findViewById(R.id.btAdicionarAnexo);
        Button btAdicionar = (Button)findViewById(R.id.btAdicionarExercicio);
        ...
        btSelecionarAnexo.setOnClickListener(new View.OnClickListener()
        {
              ...
              {
                  ActivityCompat.requestPermissions(Activity_exercicio_adicionar.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, code);
              }
        });
        ...
        btVoltar.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                Intent intent = new Intent(Activity_exercicio_adicionar.this, Activity_exercicio.class);
